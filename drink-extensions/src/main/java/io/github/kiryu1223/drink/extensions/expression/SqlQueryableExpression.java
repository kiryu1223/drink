...
public class SqlQueryableExpression extends ISqlTableExpression
{
    ...
    public SqlQueryableExpression(SqlSelectExpression select, ISqlFromExpression from, SqlJoinsExpression joins, SqlWhereExpression where, SqlGroupByExpression groupBy, ISqlHavingExpression having, ISqlOrderByExpression orderBy, SqlLimitExpression limit)
    {
        this.select = select;
        this.from = from;
        this.joins = joins;
