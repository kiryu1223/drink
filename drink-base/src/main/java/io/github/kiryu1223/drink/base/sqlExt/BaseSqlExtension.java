...
public abstract class BaseSqlExtension {
    public abstract ISqlExpression parse(IConfig config, Method sqlFunc, List<ISqlExpression> args, boolean[] useSuper);

    public ISqlExpression callSuper(ISqlExpression superValue, ISqlExpression thisValue) {
        return thisValue;
    }
