 ...
 * @since 3.0
 */
public class Group7<Key, T1, T2, T3, T4, T5, T6, T7> extends Group6<Key, T1, T2, T3, T4, T5, T6> {
    public T7 value7;
...
//     */
//    public <R> R sum(Func7<T1, T2, T3, T4, T5, T6, T7, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func7<T1, T2, T3, T4, T5, T6, T7, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func7<T1, T2, T3, T4, T5, T6, T7, R> expr) {
//        boom();
//        return "";
//    }
}
