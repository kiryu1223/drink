 ...
 * @since 3.0
 */
public class Group6<Key, T1, T2, T3, T4, T5, T6> extends Group5<Key, T1, T2, T3, T4, T5> {
    public T6 value6;
...
//     */
//    public <R> R sum(Func6<T1, T2, T3, T4, T5, T6, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func6<T1, T2, T3, T4, T5, T6, Number> expr) {
//        boom();
