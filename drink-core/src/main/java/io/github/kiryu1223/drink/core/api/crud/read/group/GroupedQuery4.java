 ...
 * @since 3.0
 */
public class GroupedQuery4<Key, T1, T2, T3, T4> extends QueryBase<GroupedQuery4<Key, T1, T2, T3, T4>,Key> {
     ...
     */
    public <R> EndQuery<R> select(@Expr(Expr.BodyType.Expr) Func1<Group4<Key, T1, T2, T3, T4>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<R> select(ExprTree<Func1<Group4<Key, T1, T2, T3, T4>, R>> expr) {
        select(expr.getTree());
