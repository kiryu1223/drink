 ...
 * @since 3.0
 */
public class Group5<Key, T1, T2, T3, T4, T5> extends Group4<Key, T1, T2, T3, T4> {
    public T5 value5;
...
//     */
//    public <R> R sum(Func5<T1, T2, T3, T4, T5, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func5<T1, T2, T3, T4, T5, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func5<T1, T2, T3, T4, T5, R> expr) {
//        boom();
//        return "";
//    }
}
