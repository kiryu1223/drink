 ...
 * @since 3.0
 */
public class GroupedQuery3<Key, T1, T2, T3> extends QueryBase<GroupedQuery3<Key, T1, T2, T3>,Key> {
     ...
     */
    public <R> EndQuery<R> select(@Expr(Expr.BodyType.Expr) Func1<Group3<Key, T1, T2, T3>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<R> select(ExprTree<Func1<Group3<Key, T1, T2, T3>, R>> expr) {
        select(expr.getTree());
