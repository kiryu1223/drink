...
public class LUpdate7<T1, T2, T3, T4, T5, T6, T7> extends UpdateBase<LUpdate7<T1, T2, T3, T4, T5, T6, T7>> {
    ...
    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setColumn(@Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> func,@Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setColumn(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> func, ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> value) {
    ...
    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setColumnIf(boolean condition, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> func,@Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setColumnIf(boolean condition, ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> func, ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> value) {
     ...
     * 当value不为null时更新字段
     */
    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setIfNotNull(@Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> func, R value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setIfNotNull(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> func, R value) {
     ...
     * 当value匹配条件时更新字段
     */
    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setIfMatch(@Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, T7, R> func, R value, Func1<R,Boolean> predicate) {
        throw new NotCompiledException();
    }

    public <R> LUpdate7<T1, T2, T3, T4, T5, T6, T7> setIfMatch(ExprTree<Func7<T1, T2, T3, T4, T5, T6, T7, R>> func, R value,Func1<R,Boolean> predicate) {
        setIf(predicate.invoke(value), func, value);
        return this;
    }

    public LUpdate7<T1, T2, T3, T4, T5, T6, T7> set(@Expr(Expr.BodyType.Expr) Action7<T1, T2, T3, T4, T5, T6, T7> action) {
        throw new NotCompiledException();
    }

    public LUpdate7<T1, T2, T3, T4, T5, T6, T7> set(ExprTree<Action7<T1, T2, T3, T4, T5, T6, T7>> action) {
        set(action.getTree());
        return this;
    }

    public LUpdate7<T1, T2, T3, T4, T5, T6, T7> setIf(boolean condition, @Expr(Expr.BodyType.Expr) Action7<T1, T2, T3, T4, T5, T6, T7> action) {
        throw new NotCompiledException();
    }
