 ...
 * @since 3.0
 */
public class Group10<Key, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends Group9<Key, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    public T10 value10;
...
//     */
//    public <R> R sum(Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> expr) {
//        boom();
//        return "";
//    }
}
