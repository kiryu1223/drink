...
public class LQuery2<T1, T2> extends QueryBase<LQuery2<T1, T2>,T1> {
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery3<T1, T2, Tn> innerJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func3<T1, T2, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery3<T1, T2, Tn> innerJoin(EndQuery<Tn> target, ExprTree<Func3<T1, T2, Tn, Boolean>> expr) {
        join(JoinType.INNER, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery3<T1, T2, Tn> leftJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func3<T1, T2, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery3<T1, T2, Tn> leftJoin(EndQuery<Tn> target, ExprTree<Func3<T1, T2, Tn, Boolean>> expr) {
        join(JoinType.LEFT, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery3<T1, T2, Tn> rightJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func3<T1, T2, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery3<T1, T2, Tn> rightJoin(EndQuery<Tn> target, ExprTree<Func3<T1, T2, Tn, Boolean>> expr) {
        join(JoinType.RIGHT, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery2<T1, T2> orderBy(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderBy(ExprTree<Func2<T1, T2, R>> expr, boolean asc) {
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery2<T1, T2> orderBy(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderBy(ExprTree<Func2<T1, T2, R>> expr) {
        orderBy(expr.getTree(), true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByDesc(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByDesc(ExprTree<Func2<T1, T2, R>> expr) {
        orderBy(expr, false);
        return this;
    }
    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByIf(boolean condition, ExprTree<Func2<T1, T2, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByIf(boolean condition, ExprTree<Func2<T1, T2, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery2<T1, T2> orderByDescIf(boolean condition, ExprTree<Func2<T1, T2, R>> expr) {
     ...
     */
    public <R> EndQuery<R> select(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<R> select(ExprTree<Func2<T1, T2, R>> expr) {
        select(expr.getTree());
    ...
    public <R extends Result> LQuery<R> withTemp(@Expr(Expr.BodyType.Expr) Func2<T1,T2, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<R> withTemp(ExprTree<Func2<T1,T2, R>> expr) {
        select(expr.getTree());
        withTempQuery();
