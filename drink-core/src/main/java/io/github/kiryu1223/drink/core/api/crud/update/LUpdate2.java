 ...
 * @since 3.0
 */
public class LUpdate2<T1, T2> extends UpdateBase<LUpdate2<T1, T2>> {
     ...
     * 当value不为null时更新字段
     */
    public <R> LUpdate2<T1, T2> setIfNotNull(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> func, R value) {
        throw new NotCompiledException();
    }

    public <R> LUpdate2<T1, T2> setIfNotNull(ExprTree<Func2<T1, T2, R>> func, R value) {
     ...
     * 当value匹配条件时更新字段
     */
    public <R> LUpdate2<T1, T2> setIfMatch(@Expr(Expr.BodyType.Expr) Func2<T1, T2, R> func, R value,Func1<R,Boolean> predicate) {
        throw new NotCompiledException();
    }

    public <R> LUpdate2<T1, T2> setIfMatch(ExprTree<Func2<T1, T2, R>> func, R value,Func1<R,Boolean> predicate) {
        setIf(predicate.invoke(value), func, value);
        return this;
    }

    public LUpdate2<T1, T2> set(@Expr(Expr.BodyType.Expr) Action2<T1, T2> action) {
        throw new NotCompiledException();
    }

    public LUpdate2<T1, T2> set(ExprTree<Action2<T1, T2>> action) {
        set(action.getTree());
        return this;
    }

    public LUpdate2<T1, T2> setIf(boolean condition, @Expr(Expr.BodyType.Expr) Action2<T1, T2> action) {
        throw new NotCompiledException();
    }

    public LUpdate2<T1, T2> setIf(boolean condition, ExprTree<Action2<T1, T2>> action) {
