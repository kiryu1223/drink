 ...
 * @since 3.0
 */
public class GroupedQuery6<Key, T1, T2, T3, T4, T5, T6> extends QueryBase<GroupedQuery6<Key, T1, T2, T3, T4, T5, T6>> {
     ...
     */
    public <R> EndQuery<R> select(@Expr(Expr.BodyType.Expr) Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<R> select(ExprTree<Func1<Group6<Key, T1, T2, T3, T4, T5, T6>, R>> expr) {
        select(expr.getTree());
