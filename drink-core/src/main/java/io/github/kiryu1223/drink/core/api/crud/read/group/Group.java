 ...
 * @since 3.0
 */
public class Group<Key, T> implements IGroup {
    public Key key;
    public T value1;
...
//     */
//    public BigDecimal avg(Func1<T, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func1<T, R> expr) {
//        boom();
//        return "";
//    }
}
