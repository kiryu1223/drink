 ...
 * @since 3.0
 */
public class Group9<Key, T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Group8<Key, T1, T2, T3, T4, T5, T6, T7, T8> {
    public T9 value9;
...
//     */
//    public <R> R sum(Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> expr) {
//        boom();
//        return "";
//    }
}
