 ...
 * @since 3.0
 */
public class Group2<Key, T1, T2> extends Group<Key, T1> {
    public T2 value2;
...
//     */
//    public <R> R sum(Func2<T1, T2, R> expr) {
//        boom();
//        return (R) new Object();
//    }
//
...
//     */
//    public BigDecimal avg(Func2<T1, T2, Number> expr) {
//        boom();
...
//    }
//
//    public <R> String groupJoin(Func2<T1, T2, R> expr) {
//        boom();
//        return "";
//    }
}
