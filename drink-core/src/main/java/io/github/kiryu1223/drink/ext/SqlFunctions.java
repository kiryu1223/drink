...
//    }
    ...
    @SqlFuncExt(dbType = DbType.H2, function = "DATEFORMAT({},{})")
    @SqlFuncExt(dbType = DbType.MySQL, function = "DATEFORMAT({},{})")
...
//    @SqlFuncExt(dbType = DbType.H2, function = "CONVERT({targetType},{value})")
