 ...
 * @since 3.0
 */
public class LQuery6<T1, T2, T3, T4, T5, T6> extends QueryBase<LQuery6<T1, T2, T3, T4, T5, T6>,T1> {
    // region [INIT]
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> innerJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> innerJoin(EndQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
        join(JoinType.INNER, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> leftJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> leftJoin(EndQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
        join(JoinType.LEFT, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return 泛型数量+1的查询过程对象
     */
    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> rightJoin(EndQuery<Tn> target, @Expr(Expr.BodyType.Expr) Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean> func) {
        throw new NotCompiledException();
    }

    public <Tn> LQuery7<T1, T2, T3, T4, T5, T6, Tn> rightJoin(EndQuery<Tn> target, ExprTree<Func7<T1, T2, T3, T4, T5, T6, Tn, Boolean>> expr) {
        join(JoinType.RIGHT, target, expr.getTree());
        return joinNewQuery();
    }
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderBy(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderBy(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr, boolean asc) {
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderBy(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderBy(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        orderBy(expr, true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByDesc(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByDesc(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery6<T1, T2, T3, T4, T5, T6> orderByDescIf(boolean condition, ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
     ...
     */
    public <R> EndQuery<R> select(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<R> select(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        select(expr.getTree());
    ...
    public <R extends Result> LQuery<R> withTemp(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<R> withTemp(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        select(expr.getTree());
        withTempQuery();
