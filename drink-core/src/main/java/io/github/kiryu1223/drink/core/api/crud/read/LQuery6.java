...
//    }
     ...
     */
    public <R> EndQuery<? extends R> select(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R> EndQuery<? extends R> select(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        select(expr.getTree());
...
//    }
    ...
    public <R extends Result> LQuery<? extends R> withTemp(@Expr(Expr.BodyType.Expr) Func6<T1, T2, T3, T4, T5, T6, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<? extends R> withTemp(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr) {
        select(expr.getTree());
        withTempQuery();
