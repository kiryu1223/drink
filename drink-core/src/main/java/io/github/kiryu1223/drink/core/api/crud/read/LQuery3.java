 ...
 * @since 3.0
 */
public class LQuery3<T1, T2, T3> extends QueryBase<LQuery3<T1, T2, T3>,T1> {
    // region [INIT]
...
//    }
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderBy(@Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderBy(ExprTree<Func3<T1, T2, T3, R>> expr, boolean asc) {
     ...
     * @return this
     */
    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderBy(@Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderBy(ExprTree<Func3<T1, T2, T3, R>> expr) {
        orderBy(expr, true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByDesc(@Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByDesc(ExprTree<Func3<T1, T2, T3, R>> expr) {
        orderBy(expr, false);
        return this;
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr, boolean asc) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByIf(boolean condition, ExprTree<Func3<T1, T2, T3, R>> expr, boolean asc) {
        if (condition) orderBy(expr.getTree(), asc);
        return this;
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByIf(boolean condition, @Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByIf(boolean condition, ExprTree<Func3<T1, T2, T3, R>> expr) {
        if (condition) orderBy(expr, true);
        return this;
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByDescIf(boolean condition, @Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr) {
        throw new NotCompiledException();
    }

    public  <R extends Comparable<R>> LQuery3<T1, T2, T3> orderByDescIf(boolean condition, ExprTree<Func3<T1, T2, T3, R>> expr) {
...
//    }
    ...
    public <R extends Result> LQuery<? extends R> withTemp(@Expr(Expr.BodyType.Expr) Func3<T1, T2, T3, R> expr) {
        throw new NotCompiledException();
    }

    public <R extends Result> LQuery<? extends R> withTemp(ExprTree<Func3<T1, T2, T3, R>> expr) {
        select(expr.getTree());
        withTempQuery();
