...
import static io.github.kiryu1223.drink.func.SqlFunctions.cast;
import static io.github.kiryu1223.drink.func.SqlFunctions.concat;
...
//                                            ? concat(cast(c.getFromUserId(), String.class), "_", cast(c.getToUserId(), String.class))
